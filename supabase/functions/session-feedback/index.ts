...
Provide your structured feedback as JSON.`;
            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  leadership_score: { type: "integer", minimum: 0, maximum: 100 },
                  teamwork_score: { type: "integer", minimum: 0, maximum: 100 },
    ...
    console.log(`session-feedback provider: ${data._provider}`);
