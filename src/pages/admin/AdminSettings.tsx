...
const DEFAULT_FLAGS = [
  ...
  { key: "ads.network", value: "adsense", desc: 'Active ad network: "adsense" | "medianet" | "ezoic" | "carbon" | "none".' },
  { key: "ads.medianet_cid", value: "", desc: "Media.net customer ID (cid) from the Media.net dashboard." },
  { key: "ads.medianet_crid", value: "", desc: "Media.net ad unit ID (crid)." },
  { key: "ads.ezoic_placeholder_id", value: 0, desc: "Ezoic placeholder ID to render (0 = disabled)." },
  { key: "ads.carbon_serve", value: "", desc: "Carbon Ads 'serve' token." },
  { key: "ads.carbon_placement", value: "", desc: "Carbon Ads 'placement' token." },
