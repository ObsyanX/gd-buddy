          ...
          <Card className="p-6 border-4 border-border space-y-4">
            ...
            <div className="space-y-3 font-mono text-sm">
              <div className="flex justify-between items-center p-3 border-2 border-border">
                ...
                <kbd className="px-3 py-1 bg-muted border-2 border-border font-bold">Ctrl + M</kbd>
              </div>
              <div className="flex justify-between items-center p-3 border-2 border-border">
                <span className="text-muted-foreground">Send Message</span>
                <kbd className="px-3 py-1 bg-muted border-2 border-border font-bold">Ctrl + Enter</kbd>
              </div>
              <div className="flex justify-between items-center p-3 border-2 border-border">
                <span className="text-muted-foreground">Stop TTS Playback</span>
                <kbd className="px-3 py-1 bg-muted border-2 border-border font-bold">Escape</kbd>
              </div>
            </div>
          </Card>
        </div>
